            ...
            <tbody className="divide-y divide-slate-50 dark:divide-slate-800">
              ...
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60 align-top">
                ...
                <td className="px-6 py-3">
                  {issued1 ? (
                    <span className="font-mono text-xs font-semibold text-emerald-700 dark:text-emerald-400">{issued1.pnr}</span>
                  ) : (
                    <>
                      <input
                        value={pnr1}
              ...
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60 align-top">
                ...
                <td className="px-6 py-3">
                  {issued2 ? (
                    <span className="font-mono text-xs font-semibold text-emerald-700 dark:text-emerald-400">{issued2.pnr}</span>
                  ) : (
                    <>
                      <input
                        value={pnr2}
              ...
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60 align-top">
                ...
                <td className="px-6 py-3">
                  {issued3 ? (
                    <span className="font-mono text-xs font-semibold text-emerald-700 dark:text-emerald-400">{issued3.pnr}</span>
                  ) : (
                    <>
                      <input
                        value={pnr3}
              ...
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60 align-top">
                ...
                <td className="px-6 py-3">
                  {issued4 ? (
                    <span className="font-mono text-xs font-semibold text-emerald-700 dark:text-emerald-400">{issued4.pnr}</span>
                  ) : (
                    <>
                      <input
                        value={pnr4}
              ...
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60 align-top">
                ...
                <td className="px-6 py-3">
                  {issued5 ? (
                    <span className="font-mono text-xs font-semibold text-emerald-700 dark:text-emerald-400">{issued5.pnr}</span>
                  ) : (
                    <>
                      <input
                        value={pnr5}
