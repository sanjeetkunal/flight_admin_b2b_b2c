    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 rounded-xl border border-slate-100 bg-white px-4 py-3 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button className="rounded-lg px-3 py-1.5 text-xs font-medium text-slate-500 hover:bg-slate-100">Reissued <span className="ml-0.5 opacity-70">(1)</span></button>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-green-100 bg-green-50 px-3 py-2">
          ...
          <span className="text-sm font-bold text-green-600">₹1,670</span>
          <span className="text-xs text-green-600/70">Fare Difference Due</span>
        </div>
      ...
      <div className="rounded-xl border border-slate-100 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-50 dark:divide-slate-800">
              ...
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60">
                <td className="px-6 py-3 font-mono text-xs font-semibold text-green-700">RIS-4001</td>
                <td className="px-6 py-3 font-mono text-xs text-slate-500">6712345890</td>
              ...
              {/* RIS-4002 */}
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60">
                <td className="px-6 py-3 font-mono text-xs font-semibold text-green-700">RIS-4002</td>
                <td className="px-6 py-3 font-mono text-xs text-slate-500">9045678123</td>
              ...
              {/* RIS-4003 */}
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60">
                <td className="px-6 py-3 font-mono text-xs font-semibold text-green-700">RIS-4003</td>
                <td className="px-6 py-3 font-mono text-xs text-slate-500">2109876543</td>
              ...
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60">
                <td className="px-6 py-3 font-mono text-xs font-semibold text-green-700">RIS-3998</td>
                <td className="px-6 py-3 font-mono text-xs text-slate-500">8934567012</td>
                ...
                <td className="px-6 py-3"><span className="rounded-full bg-emerald-100 px-2.5 py-0.5 text-xs font-medium text-emerald-700">Reissued</span></td>
                <td className="px-6 py-3">
                  <div className="flex items-center gap-2">
              ...
              <tr className="hover:bg-slate-50/60 transition-colors dark:hover:bg-slate-800/60">
                <td className="px-6 py-3 font-mono text-xs font-semibold text-green-700">RIS-3991</td>
                <td className="px-6 py-3 font-mono text-xs text-slate-500">1056789234</td>
        ...
        <div className="flex items-center justify-between border-t border-slate-100 px-6 py-4">
          <p className="text-xs text-slate-500">Showing 5 of 5 reissue requests</p>
