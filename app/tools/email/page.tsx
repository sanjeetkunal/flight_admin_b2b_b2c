...
const attachments = [
  { icon: "figma", name: "studio-admin.fig", size: "21 MB", color: "bg-purple-500/15 text-purple-300" },
  { icon: "doc", name: "features.docx", size: "3.7 MB", color: "bg-blue-500/15 text-blue-300" },
  { icon: "image", name: "preview.png", size: "2.3 MB", color: "bg-emerald-500/15 text-emerald-300" },
]

function IconBtn({ children }: { children: React.ReactNode }) {
  return (
    <button className="flex h-8 w-8 items-center justify-center rounded-lg text-neutral-500 hover:bg-neutral-800 hover:text-neutral-200 transition-colors">
      {children}
    </button>
  )
}
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center justify-between gap-2">
          ...
          <span className="flex-shrink-0 text-[11px] text-neutral-500">{email.time}</span>
        </div>
        <p className="truncate text-sm text-neutral-300">{email.subject}</p>
        <p className="mt-0.5 line-clamp-2 text-xs text-neutral-500">{email.preview}</p>
      </div>
    </div>
  )
}
...
export default function EmailPage() {
  return (
    <div className="flex h-[calc(100vh-140px)] min-h-[640px] overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-950 text-neutral-100 shadow-xl">
      {/* Left sidebar */}
      <aside className="hidden w-64 flex-shrink-0 flex-col border-r border-neutral-800/80 p-4 md:flex">
        <div className="mb-6 flex items-center gap-2">
          <div className="relative flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-violet-400 to-purple-700 text-xs font-semibold text-white">
            A
            <span className="absolute -bottom-0.5 -right-0.5 h-3.5 w-3.5 rounded-full border-2 border-neutral-950 bg-emerald-500" />
          </div>
          ...
          <button className="ml-auto flex h-8 w-8 items-center justify-center rounded-lg text-neutral-500 hover:bg-neutral-900 hover:text-neutral-300">
        ...
        <div className="mb-5">
          <p className="text-sm font-semibold text-white">Arham Khan</p>
          <p className="text-xs text-neutral-500">hello@arhamkhnz.com</p>
        </div>

        <button className="mb-5 flex items-center justify-center gap-2 rounded-full bg-neutral-100 py-2.5 text-sm font-medium text-neutral-900 transition-colors hover:bg-white">
        ...
        <nav className="space-y-1 text-sm">
          <div className="flex items-center gap-3 rounded-lg bg-amber-400 px-3 py-2 font-medium text-neutral-900">
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex items-center gap-3 rounded-lg px-3 py-2 text-neutral-400 hover:bg-neutral-900">
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
            </svg>
            Priority
            <span className="ml-auto text-xs text-neutral-500">3</span>
          </div>
        </nav>

        <p className="mb-2 mt-6 text-[11px] font-semibold uppercase tracking-wider text-neutral-600">
          Folders
        </p>
        <nav className="flex-1 space-y-1 text-sm">
          <div className="flex items-center gap-3 rounded-lg px-3 py-2 text-neutral-400 hover:bg-neutral-900">
            ...
            Drafts
            <span className="ml-auto text-xs text-neutral-500">9</span>
          </div>
          <div className="flex items-center gap-3 rounded-lg px-3 py-2 text-neutral-400 hover:bg-neutral-900">
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mt-auto space-y-1 border-t border-neutral-800/80 pt-3 text-sm">
          <div className="flex cursor-pointer items-center gap-3 rounded-lg px-3 py-2 text-neutral-500 hover:bg-neutral-900">
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Middle inbox list */}
      <section className="flex w-full flex-shrink-0 flex-col border-r border-neutral-800/80 md:w-[380px]">
        <div className="flex items-center justify-between border-b border-neutral-800/80 px-4 py-4">
        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-2 rounded-lg bg-neutral-900 px-3 py-2 text-sm text-neutral-500">
        ...
        <div className="flex-1 overflow-y-auto">
          <p className="px-4 pb-1 text-xs font-medium text-neutral-500">Pinned (4)</p>
          <div>
          ...
          <p className="px-4 pb-1 pt-3 text-xs font-medium text-neutral-500">Inbox (13)</p>
          <div>
      ...
      <section className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <h1 className="text-xl font-semibold text-white">Meeting Tomorrow</h1>
          <p className="mt-1 text-xs text-neutral-500">Thu, 2 Jul 2026, 9:20 AM</p>

          <div className="mt-4 flex items-start justify-between gap-4 border-b border-neutral-800/80 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm">
                <span className="font-medium text-neutral-100">William Smith</span>
                <span className="text-neutral-500"> | williamsmith@example.com</span>
              </div>
            </div>
          ...
          <div className="mt-4">
            <button className="flex items-center gap-1.5 text-xs font-medium text-neutral-400">
              Attachments (3)
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {attachments.map((a) => (
                <div
                  key={a.name}
                  className="flex items-center gap-2 rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2 text-xs"
                >
        ...
        <div className="border-t border-neutral-800/80 px-6 py-4">
          <div className="flex items-center gap-3 rounded-full border border-neutral-800 bg-neutral-900 px-4 py-2.5">
            <svg className="h-4 w-4 flex-shrink-0 text-neutral-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <polyline points="9 14 4 9 9 4" />
              <path d="M20 20v-7a4 4 0 00-4-4H4" />
            </svg>
            <span className="flex-1 truncate text-sm text-neutral-500">Reply William Smith...</span>
            ...
            <button className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-neutral-100 text-neutral-900 hover:bg-white">
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
